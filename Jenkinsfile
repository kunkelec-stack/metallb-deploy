pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/kunkelec-stack/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('kunkelec-225-sp26')   // <---- Change this to match your kubernetes cluster credentials
    }
